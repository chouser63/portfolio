...
variable "frontend_max_capacity" {
  description = "Maximum capacity for the frontend service"
  default = 4
}

variable "frontend_min_capacity" {
  description = "Minimum capacity for the frontend service"
  default = 2
}

variable "frontend_cpu_target_value" {
  description = "Target CPU utilization for the frontend service"
  default = 50
}